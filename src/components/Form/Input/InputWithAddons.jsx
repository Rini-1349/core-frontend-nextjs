 ...
 * @returns
 */
export const InputWithAddons = ({ icon, type = "text", name, value, onChange, defaultValue, placeholder = "", errorMessage = "", required = false, className = "", disabled = false, title = "", label }) => {
  return (
    <>
